    ...
    public class Migrator
    {
        ...
        public void Show()
        {
            lock (syncRoot)
            {
                ...
                projectsUpdateList.SelectedFired += () =>
                {
                    projectsUpdateList.State = "";
                };
            ...
            return Task.Run(() =>
                {
                    ...
                    if (updated == 0)
                    {
                        synchronizationContext.Post(o =>
                        {
                            projectsUpdateList.State = "No project selected!";
                        }, null);
                    }
                    else
                    {
                        synchronizationContext.Post(o =>
                        {
                            var updatedState = (int)o;
                            projectsUpdateList.State = $"Done! {updatedState} projects updated";
                        }, updated);
                    }
                });
        }
